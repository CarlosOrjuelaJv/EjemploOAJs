...
var plSTF="none",ctrPlS="none",minPlW="0",maxPlW=undefined,plWidth="1024px",plHeight="640px";
...
preContent={
    dom: [
    {
        ...
        type: 'image',
        tag: 'img',
        rect: ['443', '239','159px','158px','auto', 'auto'],
        fill: ["rgba(0,0,0,0)",'images/precarga2.gif','0px','0px']
    }]};//simpleContent
